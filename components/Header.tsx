...
export function Header() {
  return (
    <header className="mb-9 text-center sm:mb-12">
      <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-700 text-white shadow-lg shadow-blue-200/60">
